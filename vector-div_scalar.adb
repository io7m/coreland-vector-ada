package body vector.div_scalar is
  ...
  procedure vec_div_scalar_f (a: in out vector_f_t; sc: scalar_f_t; n: ic.int);
  pragma import (c, vec_div_scalar_f, "vec_divscNf_aligned");
  procedure vec_div_scalar_fx (a: vector_f_t; x: out vector_f_t; sc: scalar_f_t; n: ic.int);
  pragma import (c, vec_div_scalar_fx, "vec_divscNfx_aligned");

  procedure vec_div_scalar_d (a: in out vector_d_t; sc: scalar_d_t; n: ic.int);
  pragma import (c, vec_div_scalar_d, "vec_divscNd_aligned");
  procedure vec_div_scalar_dx (a: vector_d_t; x: out vector_d_t; sc: scalar_d_t; n: ic.int);
