package body vector.mult_scalar is
  ...
  procedure vec_mult_scalar_f (a: in out vector_f_t; sc: scalar_f_t; n: ic.int);
  pragma import (c, vec_mult_scalar_f, "vec_multscNf_aligned");
  procedure vec_mult_scalar_fx (a: vector_f_t; x: out vector_f_t; sc: scalar_f_t; n: ic.int);
  pragma import (c, vec_mult_scalar_fx, "vec_multscNfx_aligned");

  procedure vec_mult_scalar_d (a: in out vector_d_t; sc: scalar_d_t; n: ic.int);
  pragma import (c, vec_mult_scalar_d, "vec_multscNd_aligned");
  procedure vec_mult_scalar_dx (a: vector_d_t; x: out vector_d_t; sc: scalar_d_t; n: ic.int);
