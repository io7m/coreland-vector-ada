...
begin
  ...
  begin
    v16_subsc.f (tmp_a, base_sc);
    check (tmp_a);
  end;

  --
  -- subsc, external storage
  --

  declare
    tmp_a : v16.vector_f_t := base_a;
  begin
    v16_subsc.f_ext (base_a, tmp_a, base_sc);
    check (tmp_a);
  end;
