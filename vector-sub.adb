...
package body vector.sub is
  ...
  procedure vec_sub_f (a: in out vector_f_t; b: vector_f_t; n: ic.int);
  pragma import (c, vec_sub_f, "vec_subNf_aligned");
  procedure vec_sub_fx (a: vector_f_t; b: vector_f_t; x: out vector_f_t; n: ic.int);
  pragma import (c, vec_sub_fx, "vec_subNfx_aligned");

  procedure vec_sub_d (a: in out vector_d_t; b: vector_d_t; n: ic.int);
  pragma import (c, vec_sub_d, "vec_subNd_aligned");
  procedure vec_sub_dx (a: vector_d_t; b: vector_d_t; x: out vector_d_t; n: ic.int);
