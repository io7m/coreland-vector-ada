package body vector.normalize is
  ...
  procedure vec_normalize_f (a: in out vector_f_t; n: ic.int);
  pragma import (c, vec_normalize_f, "vec_normNf_aligned");
  procedure vec_normalize_fx (a: vector_f_t; x: out vector_f_t; n: ic.int);
  pragma import (c, vec_normalize_fx, "vec_normNfx_aligned");

  procedure vec_normalize_d (a: in out vector_d_t; n: ic.int);
  pragma import (c, vec_normalize_d, "vec_normNd_aligned");
  procedure vec_normalize_dx (a: vector_d_t; x: out vector_d_t; n: ic.int);
