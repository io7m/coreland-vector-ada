package body vector.add is
  ...
  procedure vec_add_f (a: in out vector_f_t; b: vector_f_t; n: ic.int);
  pragma import (c, vec_add_f, "vec_addNf_aligned");
  procedure vec_add_fx (a: vector_f_t; b: vector_f_t; x: out vector_f_t; n: ic.int);
  pragma import (c, vec_add_fx, "vec_addNfx_aligned");

  procedure vec_add_d (a: in out vector_d_t; b: vector_d_t; n: ic.int);
  pragma import (c, vec_add_d, "vec_addNd_aligned");
  procedure vec_add_dx (a: vector_d_t; b: vector_d_t; x: out vector_d_t; n: ic.int);
